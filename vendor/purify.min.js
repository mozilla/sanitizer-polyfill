...
!(function (e, t) {
  ...
  return (function e() {
    ...
    var it = function (e) {
      ...
      pt = function (e, t, n) {
        if (Ue && ("id" === t || "name" === t) && (n in o || n in Qe))
          return !1;
        if (Re && !Ee[t] && A(he, t));
        else if (De && A(ye, t));
        else {
      ...
      ht = function e(t) {
        ...
        for (mt("beforeSanitizeShadowDOM", t, null); (n = r.nextNode()); )
          mt("uponSanitizeShadowNode", n, null),
            dt(n) || (n.content instanceof a && e(n.content), gt(n));
    ...
    return (
      (n.sanitize = function (e, o) {
        var i = void 0,
          ...
          f = void 0;
        if (
          ((Ze = !e) && (e = "\x3c!--\x3e"), "string" != typeof e && !ft(e))
        ) {
        ...
        if (
          (Me || et(o), (n.removed = []), "string" == typeof e && (je = !1), je)
        );
        else if (e instanceof c)
          (1 ===
            (l = (i = ct("\x3c!----\x3e")).ownerDocument.importNode(e, !0))
              .nodeType &&
            "BODY" === l.nodeName) ||
          "HTML" === l.nodeName
            ? (i = l)
        ...
        for (var m = st(je ? e : i); (s = m.nextNode()); )
          (3 === s.nodeType && s === u) ||
            dt(s) ||
            (s.content instanceof a && ht(s.content), gt(s), (u = s));
